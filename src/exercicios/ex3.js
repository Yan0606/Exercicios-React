...
function Exercicio3() {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.heading}>Calcular Multiplicação</h2>
      <input
        type="number"
      ...
      <div className="container" style={styles.buttonContainer}>
        <button onClick={multiplicar} style={styles.button}>
          Calcular
        </button>
      </div>
      <p style={styles.result}>O valor da multiplicação é: {resultado}</p>
    </div>
  );
}
