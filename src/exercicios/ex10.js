...
function Perimetro() {
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.heading}>Perímetro do Retângulo</h2>
      <input
        type="number"
      ...
      <div className="container" style={styles.buttonContainer}>
        <button onClick={calcularPerimetro} style={styles.button}>
          Calcular
        </button>
      </div>
      <p style={styles.result}>O Perímetro do retângulo é: {resultado}</p>
    </div>
  );
}
